...
public class ARController : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        // The following function will fill m_NewTrackedPlanes with the planes that ARCore detected in current frame
        ...
        for (int i = 0; i < m_NewTrackedPlanes.Count; i++)
        {
            ...
            // This function will set the postion of grid and modify the vrtices of the attached mesh
        ...
        if(Frame.Raycast(touch.position.x, touch.position.y, TrackableHitFlags.PlaneWithinPolygon, out hit))
        {
            ...
            // We want the portal to face to camera
